...
import debugProtection from '../webcrack/deobfuscate/debug-protection';
import evaluateGlobals from '../webcrack/deobfuscate/evaluate-globals';
import mergeObjectAssignments from '../webcrack/deobfuscate/merge-object-assignments';
import selfDefending from '../webcrack/deobfuscate/self-defending';
...
import {
  ...
  type PluginState,
  type Stage,
} from '../webcrack/plugin';
import jsx from '../webcrack/transforms/jsx';
import jsxNew from '../webcrack/transforms/jsx-new';
import mangle from '../webcrack/transforms/mangle';
...
import type { Bundle } from '../webcrack/unpack';
import { unpackAST } from '../webcrack/unpack';
import { isBrowser } from '../webcrack/utils/platform';

export { type Sandbox } from '../webcrack/deobfuscate';
export type { Plugin } from '../webcrack/plugin';
